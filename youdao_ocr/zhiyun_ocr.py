...
if __name__ == '__main__':
    folderPath = 'C:\Users\huxw\Desktop\OCR\zh\\'
    savePath = 'C:\Users\huxw\Desktop\\1\\'
    imgs = readFile(folderPath)
    for img in imgs:
        resFile = open(savePath + img.split('.')[0] + r'.txt', 'w')
        try:
            # img_path = r'C:\Users\huxw\Desktop\0.jpg'
            ocr_result = get_ocr_result_base64(folderPath + img)
            print(json.dumps(ocr_result, ensure_ascii=False))
            res = json.dumps(ocr_result, ensure_ascii=False)
    ...
    # ocr_result = get_ocr_result_base64(r'C:\Users\huxw\Desktop\10261.jpg')
    # print(json.dumps(ocr_result, ensure_ascii=False))
